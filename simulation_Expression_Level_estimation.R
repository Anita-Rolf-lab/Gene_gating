...
b= x[4,]
c= x[5,]
plot( b~a , type="b" , bty="l" , xlab="Time" , ylab="Expression Level" , col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=17 , ylim=c(1,70) )
#grid (NULL,20, lty = 6, col = "cornsilk2") 
lines(c ~a , col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
legend("topleft", 
       legend = c(tflag, "Wild Type"), 
